document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadMoviesInTheater() {
        fetch(`../../BE/Admin/get_movies_by_theater.php?theaterID=${theaterID}`)
            ...
            .then(movies => {
                ...
                movies.forEach(movie => {
                    ...
                    fetch(`../../BE/Admin/get_showtime.php?movieID=${movie.movieID}&theaterID=${theaterID}`)
                        .then(response => response.json())
                        .then(showtimes => {
    ...
    document.getElementById('save-showtime-button').onclick = () => {
        ...
        fetch('../../BE/Admin/add_showtime.php', {
            method: 'POST',
    ...
    function deleteShowtime(showtimeID) {
        ...
        fetch('../../BE/Admin/delete_showtime.php', {
            method: 'POST',
            headers: {
